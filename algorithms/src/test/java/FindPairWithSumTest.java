...
public class FindPairWithSumTest {
    ...
    public void testFinfPairWithSum() {
        ...
        Assertions.assertTrue(target.findPairWithSum(new int[]{0}, 5));
        Assertions.assertTrue(target.findPairWithSum(new int[]{0,1}, 5));
        Assertions.assertTrue(target.findPairWithSum(new int[]{6,7,8,9}, 5));
        Assertions.assertTrue(target.findPairWithSum(new int[]{-1,0,1,2}, 5));
